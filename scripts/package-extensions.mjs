...
const marker = JSON.parse(await readFile(resolve(root, "package.json"), "utf8"));
if (marker.version !== common.version) throw new Error("Extension and package versions differ.");
