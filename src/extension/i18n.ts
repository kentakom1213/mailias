...
const japanese: Record<string, string> = {
  ...
  "step1.domainInstruction2": "<code>workers.dev</code> ドメインを有効にするか，Custom Domain を追加してください．拡張機能が <code>/health</code> とセットアップ補助ページへアクセスするため，公開 HTTPS URL が必要です．",
  ...
  "step5.description": "Cloudflare で Worker を開き，以下の2つのランタイム設定を追加します．拡張機能画面でパスワードマネージャーが使えない場合は，ステップ1で確認した Worker URL を通常のタブで開き，ローカル補助欄からリカバリーキーを取り出したりコピーしたりできます．",
